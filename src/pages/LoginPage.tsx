...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <Helmet>
        <title>Log In | MyChemistryLab</title>
        <meta name="description" content="Log in to your MyChemistryLab account to access interactive chemistry learning tools and resources." />
      </Helmet>
